...
#ifndef TVM_RT_WASM_AOT_EXECUTOR_H
#define TVM_RT_WASM_AOT_EXECUTOR_H
 ...
 *
 * \param module_handle TVM AOTExecutor Module that exposes the functions to call. If module_handle is NULL, use the
 * system library. \param devices runtime execution device. \param num_dev the number of devices. \return Pointer of
 * TVM_RT_WASM_AotExecutor instance if successful, NULL if fail.
 */
...
#endif // TVM_RT_WASM_AOT_EXECUTOR_H
