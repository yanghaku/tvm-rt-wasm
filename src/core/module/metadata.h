/*!
 * \file module/metadata.h
 * \brief parse the module metadata
 * \author YangBo MG21330067@smail.nju.edu.cn
 */

#ifndef TVM_RT_WASM_MODULE_METADATA_H
#define TVM_RT_WASM_MODULE_METADATA_H
...
#define PARSE_FUNC_INFO(moduleInstance)                                                                                \
    ...
    TVM_RT_WASM_TrieInsertWithLen((*moduleInstance)->module_funcs_map, (const uint8_t *)blob, name_size,               \
                                  (*moduleInstance)->packed_functions + fid);                                          \
...
#endif // TVM_RT_WASM_MODULE_METADATA_H
