...
#define TVM_RT_WASM_BACKENDS_GRAPH_GRAPH_EXECUTOR_INNER_H_INCLUDE_
 ...
 * @param module TVM Module that exposes the functions to call.
...
#endif // TVM_RT_WASM_BACKENDS_GRAPH_GRAPH_EXECUTOR_INNER_H_INCLUDE_
